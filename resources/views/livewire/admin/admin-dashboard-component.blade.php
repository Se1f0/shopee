                                ...
                                <div class="row">
                                        ...
                                        <div class="icon-stat">
                                            <div class="row">
                                                <div class="col-xs-8 text-left">
                                                    <span class="icon-stat-label ml-3 mb-3">Total Revenue</span>
                                                    <span class="icon-stat-value ml-3 mt-3">${{ $totalRevenue }}</span>
                                                </div>
                                    ...
                                    <div class="col-md-3 col-sm-6">
                                        <div class="icon-stat">
                                            <div class="row">
                                                <div class="col-xs-8 text-left">
                                                    <span class="icon-stat-label ml-3 mb-3">Total Sales</span>
                                                    <span class="icon-stat-value ml-3 mt-3">{{ $totalSales }}</span>
                                                </div>
                                                <div class="col-xs-4 text-center">
                                    ...
                                    <div class="col-md-3 col-sm-6">
                                        <div class="icon-stat">
                                            <div class="row">
                                                <div class="col-xs-8 text-left">
                                                    <span class="icon-stat-label ml-3 mb-3">Today Revenue</span>
                                                    <span class="icon-stat-value ml-3 mt-3">${{ $todayRevenue }}</span>
                                                </div>
                                                <div class="col-xs-4 text-center">
                                                    <i class="fa fa-dollar icon-stat-visual bg-primary ml-3 mt-3"></i>
                                                </div>
                                    ...
                                    <div class="col-md-3 col-sm-6">
                                        <div class="icon-stat">
                                            <div class="row">
                                                <div class="col-xs-8 text-left">
                                                    <span class="icon-stat-label ml-3 mb-3">Today Sales</span>
                                                    <span class="icon-stat-value ml-3 mt-3">{{ $todaySales }}</span>
                                                </div>
                                                <div class="col-xs-4 text-center">
                                                    <i class="fa fa-gift icon-stat-visual bg-secondary ml-3 mt-3"></i>
                                                </div>
