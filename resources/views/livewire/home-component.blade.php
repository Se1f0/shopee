                                            ...
                                            <div class="product_desc">
                                                <div class="product_desc_info">
                                                    ...
                                                    <h4><a class="product_name"
                                                            href="single-product.html">{{ $sproduct->name }}</a>
                                                    </h4>
                                                    <div class="price-box">
                                                        <span
                                                            class="new-price new-price-2">${{ $sproduct->sale_price }}</span>
                                                        <span class="old-price">${{ $sproduct->regular_price }}</span>
                                                    ...
                                                    <ul class="add-actions-link">
                                                        ...
                                                        @if ($witems->contains($sproduct->id))
                                                            <li><a class="links-details" href="#"
                                                                    wire:click.prevent="removeFromWishlist({{ $sproduct->id }})"><i
                                                                        class="fa fa-heart"></i></a></li>
                                                        @else
                                                            <li><a class="links-details" href="#"
                                                                    wire:click.prevent="addToWishlist({{ $sproduct->id }},'{{ $sproduct->name }}',{{ $sproduct->regular_price }})"><i
                                    ...
                                    @foreach ($lproducts as $lproduct)
                                        <div class="col-lg-12">
                                            ...
                                            <div class="single-product-wrap">
                                                <div class="product-image">
                                                    <a
                                                        href="{{ route('product.details', ['slug' => $lproduct->slug]) }}">
                                                        <img src="{{ asset('assets/images/product/large-size') }}/{{ $lproduct->image }}"
                                                            alt="{{ $lproduct->name }}">
                                                    </a>
                                                ...
                                                <div class="product_desc">
                                                    ...
                                                    <div class="add-actions">
                                                        <ul class="add-actions-link">
                                                            ...
                                                            @else
                                                                <li><a class="links-details" href="#"
                                                                        wire:click.prevent="addToWishlist({{ $lproduct->id }},'{{ $lproduct->name }}',{{ $lproduct->regular_price }})"><i
                                                                            class="fa fa-heart-o"></i></a></li>
                                                            @endif
                                                        </ul>
                                                    </div>
                    ...
                    <div class="li-banner-2 pt-15">
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-md-6">
                                <div class="single-banner">
                                    <a href="#">
                                        <img src="{{ asset('assets/images/banner/2_1.jpg') }}"
                            ...
                            <div class="col-lg-6 col-md-6">
                                <div class="single-banner pt-xs-30">
                                    <a href="#">
                                        <img src="{{ asset('assets/images/banner/2_2.jpg') }}"
                                            alt="Li's Static Banner">
                                    </a>
                                </div>
                            </div>
                    ...
                    <div class="li-banner-2 pt-15">
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-md-6">
                                <div class="single-banner">
                                    <a href="#">
                                        <img src="{{ asset('assets/images/banner/2_3.jpg') }}"
                                            alt="Li's Static Banner">
                                    </a>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6 col-md-6">
                                <div class="single-banner pt-xs-30">
                                    <a href="#">
                                        <img src="{{ asset('assets/images/banner/2_4.jpg') }}"
                                            alt="Li's Static Banner">
                                    </a>
                                </div>
                            </div>
                    ...
                    <div class="li-banner-2 pt-15">
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-md-6">
                                <div class="single-banner">
                                    <a href="#">
                                        <img src="{{ asset('assets/images/banner/2_5.jpg') }}"
                                            alt="Li's Static Banner">
                                    </a>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6 col-md-6">
                                <div class="single-banner pt-xs-30">
                                    <a href="#">
                                        <img src="{{ asset('assets/images/banner/2_6.jpg') }}"
                                            alt="Li's Static Banner">
                                    </a>
                                </div>
                            </div>
                                ...
                                <div class="product-active owl-carousel">
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <div class="single-product-wrap">
                                            <div class="product-image">
                                                <a href="single-product.html">
                                                    <img src="{{ asset('assets/images/product/large-size/product-8.jpg') }}"
                                                        alt="Li's Product Image">
                                                </a>
                                                <span class="sticker">New</span>
                                            </div>
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <div class="single-product-wrap">
                                            <div class="product-image">
                                                <a href="single-product.html">
                                                    <img src="{{ asset('assets/images/product/large-size/product-10.jp') }}g"
                                                        alt="Li's Product Image">
                                                </a>
                                                <span class="sticker">New</span>
                                            </div>
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <div class="single-product-wrap">
                                            <div class="product-image">
                                                <a href="single-product.html">
                                                    <img src="{{ asset('assets/images/product/large-size/product-12.jp') }}g"
                                                        alt="Li's Product Image">
                                                </a>
                                                <span class="sticker">New</span>
                                            </div>
                                ...
                                <div class="product-active owl-carousel">
                                    <div class="col-lg-12">
                                        ...
                                        <div class="single-product-wrap">
                                            <div class="product-image">
                                                <a href="single-product.html">
                                                    <img src="{{ asset('assets/images/product/large-size/product-11.jp') }}g"
                                                        alt="Li's Product Image">
                                                </a>
                                                <span class="sticker">New</span>
                                            </div>
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <div class="single-product-wrap">
                                            <div class="product-image">
                                                <a href="single-product.html">
                                                    <img src="{{ asset('assets/images/product/large-size/product-7.jpg') }}"
                                                        alt="Li's Product Image">
                                                </a>
                                                <span class="sticker">New</span>
                                            </div>
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <div class="single-product-wrap">
                                            <div class="product-image">
                                                <a href="single-product.html">
                                                    <img src="{{ asset('assets/images/product/large-size/product-9.jpg') }}"
                                                        alt="Li's Product Image">
                                                </a>
                                                <span class="sticker">New</span>
                                            </div>
