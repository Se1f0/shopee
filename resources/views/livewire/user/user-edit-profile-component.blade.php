                ...
                <div class="col-sm-12 col-md-12 col-lg-6 col-xs-12">
                    ...
                    <form wire:submit.prevent="updateProfile">
                        <div class="login-form">
                            <h4 class="login-title">Edit my Profile</h4>
                            <div class="row">
                                ...
                                <div class="col-md-12 mb-20">
                                    ...
                                    <input class="mb-0" type="text" name="mobile" placeholder="Phone Number"
                                        wire:model="mobile">
                                    @error('mobile')
                                        <p class="text-danger">{{ $message }}</p>
                                    @enderror
                                ...
                                <div class="col-md-12 mb-20">
                                    <label>Line 1</label>
                                    <input class="mb-0" type="text" name="line1" placeholder="Line 1"
                                        wire:model="line1">
                                    @error('line1')
                                        <p class="text-danger">{{ $message }}</p>
                                    @enderror
                                ...
                                <div class="col-md-12 mb-20">
                                    <label>Line 2</label>
                                    <input class="mb-0" type="text" name="line2" placeholder="Line 2"
                                        wire:model="line2">
                                    @error('line2')
                                        <p class="text-danger">{{ $message }}</p>
                                    @enderror
                                ...
                                <div class="col-md-12 mb-20">
                                    <label>City</label>
                                    <input class="mb-0" type="text" name="city" placeholder="City"
                                        wire:model="city">
                                    @error('city')
                                        <p class="text-danger">{{ $message }}</p>
                                    @enderror
                                ...
                                <div class="col-md-12 mb-20">
                                    ...
                                    <input class="mb-0" type="text" name="province" placeholder="Province"
                                        wire:model="province">
                                    @error('province')
                                        <p class="text-danger">{{ $message }}</p>
                                    @enderror
                                ...
                                <div class="col-md-12 mb-20">
                                    ...
                                    <input class="mb-0" type="text" name="zipcode" placeholder="Zip Code"
                                        wire:model="zipcode">
                                    @error('zipcode')
                                        <p class="text-danger">{{ $message }}</p>
                                    @enderror
