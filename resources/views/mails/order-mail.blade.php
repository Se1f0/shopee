    ...
    <table style="width:600px; text-align:right">
        ...
        <tbody>
            @foreach ($order->orderItems as $item)
                <td><img src="{{ asset('assets/img/product') }}/{{ $item->product->image }}" width="100"></td>
            ...
            <tr>
                ...
                <td style="font-size:15px;font-weight:bold;border-top:1px solid #ccc">Subtotal : ${{ $order->subtotal }}
                </td>
            </tr>
            <tr>
                <td colspan="3"></td>
